...
<div i-ri-arrow-right-line /> <a href="https://qrcode.me.algohaven.com/" target="_blank">Anthony's QR Code Toolkit</a>
...
Using the **Compare** tab of the [toolkit](https://qrcode.me.algohaven.com/), upload both the generated image and the original QR Code, tweak the grid size, and then we could see the mismatched spots and inspect the nodes.
...
<div i-ri-qr-code-line /> <a href="https://qrcode.me.algohaven.com/" target="_blank">Anthony's QR Code Toolkit</a><br>

<div i-ri-github-fill /> <a href="https://github.com/antfu/qrcode-toolkit" target="_blank" font-mono>antfu/qrcode-toolkit</a>

Join my [<span op75 i-simple-icons-discord /> Discord Server](https://chat.me.algohaven.com), share what you are working on, and let's explore more together!
