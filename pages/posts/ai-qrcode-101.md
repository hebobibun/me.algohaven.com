...
<p>
<span i-carbon-events mr1 /> Co-authored by <a href="https://me.algohaven.com" target="_blank">Muhammad Habibullah</a>, <a href="https://space.bilibili.com/339984/" target="_blank">赛博迪克朗</a>, wangcai and <a href="https://www.xiaohongshu.com/user/profile/5be8fb806b58b745447aab0f" target="_blank">代々木</a>
</p>

> **This is a live document**, will be updated as we learn more. Check back occasionally.

A summary of discussions made in [QRBTF's Discord server](https://discord.gg/V9CNuqYfte) and [Anthony's Discord server](https://chat.me.algohaven.com). Thanks to everyone who participated in those servers.
...
- [Stylistic QR Code with Stable Diffusion](/posts/ai-qrcode) - by Muhammad Habibullah
- [Refining AI Generated QR Code](/posts/ai-qrcode-refine) - by Muhammad Habibullah
...
You can use [Anthony's QR Toolkit](https://qrcode.me.algohaven.com/) to compare the generated QR Code with the original one. It will show you the mismatches and help you to optimize the generation process.
...
We recommend using [Anthony's QR Toolkit](https://qrcode.me.algohaven.com/) to generate the QR Code. It allows you to customize the QR Code and distort it as needed.
...
<div py15>
  <div grid="~ md:cols-3 cols-2 gap-x-2 gap-y-4" lg:scale-110 md:scale-105>
    ...
    <figure important-my-0>
      ...
      <figcaption text-center>
        <b text-lg>plants</b>
        <div text-xs mt1>by <a href="https://me.algohaven.com" target="_blank">Muhammad Habibullah</a></div>
      </figcaption>
    </figure>
    <figure important-my-0>
...
<figure>
  ...
  <figcaption text-center>
    by <a href="https://me.algohaven.com/" target="_blank">Muhammad Habibullah</a>
  </figcaption>
</figure>
...
Or in the [Toolkit](https://qrcode.me.algohaven.com/), you click the <span i-carbon-chevron-down/> button on **Margin** to expand the option and have different margins for each side.
...
<div border="~ rounded-full base" px3 py1 inline text-sm float-right>
<span i-ri-book-2-line /> Credits to <a href="https://me.algohaven.com" target="_blank">Muhammad Habibullah</a>
</div>
...
In the recent update of [QR Toolkit](https://qrcode.me.algohaven.com/), we added a new option **Render Type** to only generate some specific areas of the QR Code, combining with a grey background, we could have:
...
If you are interested in contributing to this post, fixing typos, or adding new ideas, you can [edit this page on GitHub](https://github.com/antfu/me.algohaven.com/edit/main/pages/posts/ai-qrcode-101.md). Or if you are not familiar with Git, you can also go to [Anthony's Discord server](https://chat.me.algohaven.com) and discuss with us.
